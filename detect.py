...
# 配置参数（按需修改）
# --------------------
MODEL_PATH = r"Z:\py project\Wechat_Record_To_Movies\runs\voice_detect_final11\weights\best.pt"  # 训练好的模型路径（默认不用改）
TEST_IMG_PATH = r"Z:\py project\Wechat_Record_To_Movies\test\c5800f3bf6fc6b5d0ce58eaf807c2053.jpg"  # 单张测试图路径（可替换为你的测试图）
